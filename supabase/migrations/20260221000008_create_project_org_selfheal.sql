-- Self-heal org assignment in fn_create_project for single-org environments
-- Keeps tenant safety: only auto-assign when membership-derived org exists OR system has exactly one org.
